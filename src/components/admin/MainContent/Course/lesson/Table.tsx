        ...
        <div className="block">
          <div className="overflow-x-auto w-full text-[1.3rem]  border rounded-lg border-gray-300">
            <table className="w-full rounded-xl">
              <thead>
                <tr className="bg-[#3084d6] px-10 text-[1.3rem] text-[#fff] w-full">
                  ...
                  <th
                    scope="col"
                    className="p-5 w-96 text-left whitespace-nowrap leading-6 font-semibold  capitalize min-w-[150px]"
                  >
                    Ngày tạo
                  </th>
                  <th
                  ...
                  <th
                    scope="col"
                    className="p-5 ps-0 w-64   text-left whitespace-nowrap leading-6 font-semibold  capitalize"
                  >
                    Chức năng
                  </th>
                </tr>
              ...
              <tbody className="divide-y divide-gray-300 ">
                {data?.data?.map((data: any, index: number) => (
                  <tr
                    key={data?.lesson?.lesson?.id || index + 1}
