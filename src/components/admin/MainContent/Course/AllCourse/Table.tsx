  ...
  return (
    <div className="flex flex-col pt-10">
      ...
      <div className=" overflow-x-auto pb-4">
        <div className="block">
          <div className="overflow-x-auto w-full text-[1.3rem]  border rounded-lg border-gray-300">
            <table className="w-full rounded-xl">
              <thead>
                <tr className="bg-[#3084d6] px-10 text-[1.3rem] text-[#fff]">
                  <th className="p-5 text-left whitespace-nowrap leading-6 font-semibold  capitalize">
                    ID
                  </th>
                  <th
                    scope="col"
                    className="p-5 text-left whitespace-nowrap leading-6 font-semibold  capitalize"
                  >
                    Hình ảnh
                  </th>
                  <th
                  ...
                  <th
                    scope="col"
                    className="p-5 text-left whitespace-nowrap leading-6 font-semibold  capitalize min-w-[150px]"
                  >
                    Ngày tạo
                  </th>
                  <th
                  ...
                  <th
                    scope="col"
                    className="p-5 ps-0 w-40   text-left whitespace-nowrap leading-6 font-semibold  capitalize"
                  >
                    Chức năng
                  </th>
                </tr>
              ...
              <tbody className="divide-y divide-gray-300 ">
                {data?.data?.map((course: any) => (
                  <tr className="bg-white transition-all duration-500 hover:bg-gray-50">
                    ...
                    <td className="p-5 w-[30rem] text-start">
                      {course?.banner ? (
                        <img
                          className="w-[18rem]  object-cover rounded-2xl"
                          src={course?.banner}
                          alt=""
                        />
                      ) : (
                        <img
                          className="w-[18rem] h-[10rem] object-cover rounded-2xl"
                          src={
                            'https://img.freepik.com/premium-vector/modern-design-concept-no-upcoming-event-design_637684-256.jpg?semt=ais_hybrid'
                          }
                          alt=""
                        />
                      )}
                    ...
                    <td className="p-5 text-[1.2rem] whitespace-nowrap leading-6 font-medium ">
                      <Switch
                        checked={course?.isActive}
                        onChange={() =>
                          handleChecked(course?.id, !course?.isActive)
                        }
                      />
                    </td>
                    <td className="">
                      <div className="flex">
                        ...
                        <button
                          ...
                          className="p-2 relative rounded-full bg-white group transition-all duration-500 hover:bg-[#3084d6] flex item-center"
                        >
                          <svg
                            stroke="currentColor"
                            fill="currentColor"
                          ...
                          >
                            <path
                              className="fill-[#3084d6] group-hover:fill-white"
            ...
            {!data && (
              <div className="h-[20rem] text-[1.5rem] bg-[#f1f7fc] text-[#dc1d1d] flex items-center justify-center">
                Không có dữ liệu
              </div>
            )}
            <Pagination
