            ...
            <table className="w-full rounded-xl">
              <thead>
                <tr className="bg-[#3084d6] px-10 text-[1.3rem] text-[#fff]">
                  ...
                  <th
                    scope="col"
                    className="p-5 ps-0 w-28 text-left whitespace-nowrap leading-6 font-semibold  capitalize"
                  >
                    Chức năng
                  </th>
                </tr>
              ...
              <tbody className="divide-y divide-gray-300 ">
                {data?.data?.map((course: any) => (
                  <tr className="bg-white transition-all duration-500 hover:bg-gray-50">
                    ...
                    <td className="p-5 w-[30rem]">
                      {course?.banner ? (
                        <img
                          className="w-[18rem] h-full object-cover rounded-2xl"
                          src={course?.banner}
                          alt=""
                        />
                      ) : (
                        <div className="w-18rem h-[13rem] rounded-2xl text-[1.4rem] text-[#4e98cc] bg-[#d8d8d8] flex items-center justify-center">
                          Chưa cập nhật ảnh
                        </div>
                      )}
                    </td>
